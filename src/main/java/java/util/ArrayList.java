        ...
        implements List<E>, RandomAccess, Cloneable, java.io.Serializable
{
    ...
    /**
     *
     * 减小ArrayList对应底层数组的容量大小为ArrayList实际元素个数，以此减小内存占用空间。
     *
     */
    ...
    /**
     * Returns a shallow copy of this ArrayList</tt> instance.  (The
    ...
    /**
     *
     * 集合转换为数组，可以对返回的数组任意修改，而不会影响该ArrayList
     *
     */
    ...
    //清空集合：去掉对元素的引用关系，元素在内存中依然存在，除非发生GC将它们回收
    public void clear() {
        modCount++;
